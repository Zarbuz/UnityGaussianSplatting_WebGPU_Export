...
namespace GaussianSplatting.Runtime
{
    ...
    public class GaussianSplatAssetBuilder
    {
        ...
        public async Task<BuildResult> BuildAsset(NativeArray<InputSplatData> inputSplats)
        {
            ...
            if (m_Settings.formatSH >= GaussianSplatAsset.SHFormat.Cluster64k)
            {
                ...
                await Task.Yield(); // Allow GC after expensive clustering
            }
            ...
            await Task.Yield(); // Allow GC after disposal
